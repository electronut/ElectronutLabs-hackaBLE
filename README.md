...
**hackaBLE** is a tiny (~ 18 mmx 28 mm) Nordic nRF52832 based BLE development board you can embed in your BLE projects. It's designed in such that you can use it three ways:
